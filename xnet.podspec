Pod::Spec.new do |spec|
  ...
  spec.prepare_command = <<-CMD
    curl -O https://xnet-ios-1255868781.cos.ap-guangzhou.myqcloud.com/release/1.0/EGAME/v6.1.7/a1ddc4d981604f83dfa0683858e433b5f9602bce/TencentXP2P.framework.zip

Pod::Spec.new do |spec|
  ...
  spec.prepare_command = <<-CMD
    curl -O https://xnet-ios-1258344699.cos.ap-nanjing.myqcloud.com/fix/merge_from_bilibili/HUYA/v6.1.3/7b2ec88fab8c2472f922a0b6212c1c
5720bd06b9/TencentXP2P.framework.zip
